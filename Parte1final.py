...
# Função para quantizar o sinal recebe dois parametros o sinal do seno gerado e quantidade de niveis
...
# Codificação dos níveis quantizados em binário
